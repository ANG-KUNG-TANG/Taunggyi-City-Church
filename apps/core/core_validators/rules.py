...
# Pydantic validators for direct use in schemas
...
def validate_min_age(age: int) -> int:
...
def create_length_validator(min_len: int, max_len: int, field_name: str):
...
def create_choice_validator(choices: list, field_name: str):
...
def username_validator():
    ...
    return field_validator('username')(validate_username)

def email_validator():
    """Pydantic validator for email"""
    return field_validator('email')(validate_email)
...
def password_validator():
    ...
    return field_validator('password')(validate_password)
