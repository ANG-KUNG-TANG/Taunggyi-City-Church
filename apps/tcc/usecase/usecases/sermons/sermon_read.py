...
class GetSermonByIdUseCase(BaseUseCase):
    ...
    async def _on_execute(self, input_data: Dict[str, Any], user, context) -> Dict[str, Any]:
        ...
        sermon_entity = await self.sermon_repository.get_by_id(sermon_id, user)
...
class GetRecentSermonsUseCase(BaseUseCase):
    ...
    async def _on_execute(self, input_data: Dict[str, Any], user, context) -> Dict[str, Any]:
        ...
        sermons = await self.sermon_repository.get_recent_sermons(user, limit)
...
class GetSermonsByPreacherUseCase(BaseUseCase):
    ...
    async def _on_execute(self, input_data: Dict[str, Any], user, context) -> Dict[str, Any]:
        ...
        sermons = await self.sermon_repository.get_sermons_by_preacher(preacher, user)
...
class GetSermonsByDateRangeUseCase(BaseUseCase):
    ...
    async def _on_execute(self, input_data: Dict[str, Any], user, context) -> Dict[str, Any]:
        ...
        sermons = await self.sermon_repository.get_sermons_by_date_range(start_date, end_date, user)
...
class SearchSermonsUseCase(BaseUseCase):
    ...
    async def _on_execute(self, input_data: Dict[str, Any], user, context) -> Dict[str, Any]:
        ...
        sermons = await self.sermon_repository.search_sermons(search_term, user)
...
class GetAllSermonsUseCase(BaseUseCase):
    ...
    async def _on_execute(self, input_data: Dict[str, Any], user, context) -> Dict[str, Any]:
        ...
        sermons = await self.sermon_repository.get_all(user, filters)
...
for cls in [GetSermonByIdUseCase, GetRecentSermonsUseCase, GetSermonsByPreacherUseCase,
           GetSermonsByDateRangeUseCase, SearchSermonsUseCase, GetAllSermonsUseCase]:
