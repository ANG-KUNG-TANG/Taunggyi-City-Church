...
class PrayerRepository(DomainRepository):
    ...
    async def create(self, data) -> PrayerRequestEntity:
        ...
        await AuditLogger.log_create(
            user=None,
            obj=prayer,
            notes=f"Created prayer request: {prayer_entity.title}",
            ip_address="system",
            user_agent="system"
        )
    ...
    async def update(self, object_id, data) -> Optional[PrayerRequestEntity]:
        ...
        await AuditLogger.log_update(
            ...
            obj=prayer,
            changes=changes,
            notes=f"Updated prayer request: {prayer_entity.title}",
            ip_address="system",
            user_agent="system"
        )
    ...
    async def delete(self, object_id) -> bool:
        ...
        await AuditLogger.log_delete(
            user=None,
            obj=prayer,
            notes=f"Deleted prayer request: {prayer.title}",
            ip_address="system",
            user_agent="system"
        )
    ...
    async def mark_as_answered(self, prayer_id: int, user_id: int, answer_notes: str = "") -> Optional[PrayerRequestEntity]:
        ...
        if result:
            # Additional audit logging for answered status
            await AuditLogger.log_update(
                user=None,
                obj=result,
                changes={'status': {'old': PrayerStatus.ACTIVE, 'new': PrayerStatus.ANSWERED}},
                notes=f"Prayer marked as answered: {result.title}",
                ip_address="system",
                user_agent="system"
            )
...
class PrayerResponseRepository(DomainRepository):
    ...
    async def create(self, data) -> PrayerResponseEntity:
        ...
        await AuditLogger.log_create(
            user=None,
            obj=response,
            notes=f"Created prayer response for request: {response_entity.prayer_request_id}",
            ip_address="system",
            user_agent="system"
        )
    ...
    async def update(self, object_id, data) -> Optional[PrayerResponseEntity]:
        ...
        await AuditLogger.log_update(
            ...
            obj=response,
            changes=changes,
            notes=f"Updated prayer response: {response_entity.id}",
            ip_address="system",
            user_agent="system"
        )
    ...
    async def delete(self, object_id) -> bool:
        ...
        await AuditLogger.log_delete(
            user=None,
            obj=response,
            notes=f"Deleted prayer response: {response.id}",
            ip_address="system",
            user_agent="system"
        )
